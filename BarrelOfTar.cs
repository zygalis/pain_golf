...
public class BarrelOfTar : MonoBehaviour {
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            newBatSprite = bat.GetComponentInChildren<SpriteRenderer>().sprite.name + " Tar"; //assigning new bat sprite name
        ...
        Destroy(gameObject); //destroying barrel of tar gameobject after collision
    }
}
